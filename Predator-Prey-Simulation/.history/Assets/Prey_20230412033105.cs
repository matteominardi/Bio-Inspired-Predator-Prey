...
public class Prey : MonoBehaviour, ISelectable
{
    ...
    {
        GameObject child = Instantiate(gameObject, new Vector2(transform.position.x, transform.position.y) + Random.insideUnitCircle, Quaternion.Euler(0.0, 0.0, Random.Range(0.0f, 360.0f)));
        child.name = "Prey";
