...
public class Prey : MonoBehaviour, ISelectable
{
    ...
    void Reproduce(NeuralNetwork parent, int generation)
    {
        ...
        child.GetComponent<Prey>().Brain = parent.Copy(child.GetComponent<Prey>().Brain);
        child.GetComponent<Prey>().Generation = generation;
        child.GetComponent<Prey>().Brain.Mutate(20, 0.1f);
        child.GetComponent<Prey>().Brain.Fitness = 0;
        child.GetComponent<Prey>().Lifepoints = 100;
        child.GetComponent<Prey>().Fitness = 0;
        child.GetComponent<Prey>().Alive = true;
        child.GetComponent<Prey>().Energy = 100;
        child.GetComponent<Prey>().Speed = 2;
        child.GetComponent<Prey>().age = Time.time;
        child.GetComponent<Prey>().GetComponent<Raycast>().Generate(24, 300, 30);
        child.GetComponent<Prey>().GetComponent<SpriteRenderer>().color = new Color(0, 1, 0);
        child.name = "Prey";
    }
}
