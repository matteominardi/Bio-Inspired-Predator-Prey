...
public class Stats : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.DrawRay(mainCamera.ScreenToWorldPoint(Input.mousePosition), mainCamera.ScreenToWorldPoint(Input.mousePosition) - hit.collider.gameObject.GetComponent * 300, Color.red);
            print("hit");
