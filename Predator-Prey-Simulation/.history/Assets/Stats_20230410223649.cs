    ...
    void Update()
    {
        ...
        if (hit.collider != null)
        {
            if (Input.GetMouseButtonDown(0) && hit.transform.tag == "SelectableObject")
            {
                ...
                print(gameObject.transform.Find("lblHealth").transform.Find("txtHealth").GetComponent<TMPro.TextMeshPro>());//.transform.Find("txtHealth").GetComponents<MonoBehaviour>());
