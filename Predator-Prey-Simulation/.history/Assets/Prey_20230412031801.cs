...
public class Prey : MonoBehaviour, ISelectable
{
    ...
    {
        GameObject child = Instantiate(gameObject, new Vector2(transform.position.x, transform.position.y) + Random.insideUnitCircle, transform.rotation);
        child.name = "Prey";
        
        child.GetComponent<Prey>().Generate(100, 0, 1, 2, 1)
